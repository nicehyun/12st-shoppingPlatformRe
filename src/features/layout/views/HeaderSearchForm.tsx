...
const HeaderSearchForm = ({}: ISearchButton) => {
  return (
    <form className="absolute bottom-[5px] right-[26px] lg:right-[35px] xl:right-[38px] h-[34px]">
      <input className="w-[100px] focus:w-[300px] sm:focus:w-[220px] md:focus:w-[250px] h-full px-[10px] pl-[4px] pr-[30px] border-border rounded-[5px] focus:border-lightRed text-lightBlack text-[12px] dark:focus:bg-white transition-3 peer" />
      <button
        type="submit"
