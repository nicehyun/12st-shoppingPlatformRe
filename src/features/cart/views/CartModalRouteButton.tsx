...
const CartModalRouteButton = ({ content, route }: ICartModalRouteButton) => {
  ...
  return (
    <Button
      onClick={handleRoute}
      classNames="text-center font-semibold bg-white text-black hover:bg-black hover:text-white dark:hover:bg-lightRed text-[14px] md:text-[12px] sm:text-[12px] rounded-[5px] border-[1px] border-black dark:border-white my-[20px] p-[8px] transition-3"
      content={content}
    />
  )
}
